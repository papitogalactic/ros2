...
MVSIM_WORLD_FILE = os.path.join(mvsimDir, 'mvsim_tutorial','demo_elevation_map.world.xml')
MVSIM_ROS2_PARAMS_FILE = os.path.join(mvsimDir, 'mvsim_tutorial','mvsim_ros2_params.yaml')
RVIZ2_FILE = os.path.join(mvsimDir, 'mvsim_tutorial','demo_depth_camera_ros2.rviz')
